...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	<div id="basket-root" class="bx-basket bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity" style="opacity: 0;">
		...
		if (
						...
						<div class="basket-items-list-container" id="basket-items-list-container">
							...
							<div class="basket-items-list" id="basket-item-list">
								...
								<table class="basket-items-list-table" id="basket-item-table">
									<thead><tr class="basket-items-list-item-container"><td class="cart-item-name">Название и описание товара</td><td class="cart-item-name">Цена</td><td class="cart-item-name">Количество</td><td class="cart-item-name">Сумма</td><td class="cart-item-name"></td></tr></thead>
								</table>
							</div>
						</div>
					</div>
			...
			<style>.bx-basket .line{display:none !important;}</style>
			<?
			if (
				$arParams['BASKET_WITH_ORDER_INTEGRATION'] !== 'Y'
				...
				{
					?>
					<div class="row" style="border-top:1px solid #e5e8ef;">
						<div class="col-xs-12" data-entity="basket-total-block"></div>
					</div>
					<?
				}
