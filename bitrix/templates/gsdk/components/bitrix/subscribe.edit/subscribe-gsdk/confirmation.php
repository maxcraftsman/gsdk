...
<tr valign="top">
	<td width="40%">
		...
		<input class="emailsub" type="text" name="CONFIRM_CODE" value="<?echo $arResult["REQUEST"]["CONFIRM_CODE"];?>" size="20" /></p>
...
<tfoot><tr><td colspan="2"><input class="btn-order btn-order-1" type="submit" name="confirm" value="<?echo GetMessage("subscr_conf_button")?>" /></td></tr></tfoot>
</table>
