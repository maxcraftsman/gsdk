...
if(strlen($arResult["ID"])>0)
{
	...
	?>
	<form method="post"  class="col-md-12 sale-profile-detail-form" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data" style="border: 1px solid #e5e8ef;padding: 10px 30px !important;">
		<?=bitrix_sessid_post()?>
