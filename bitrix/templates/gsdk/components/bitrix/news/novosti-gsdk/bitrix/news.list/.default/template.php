...
<div class="news-list">
	...
	<span class="news-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<div class="image-sock">
			<a class="image" href="<?=$arItem["DETAIL_PAGE_URL"]?>" style='background-image:url(<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>)'></a>
		</div>
		<?else:?>
		<div class="image-sock">
		...
		<div class="news-desc">
			...
			<?echo TruncateText($arItem["PREVIEW_TEXT"], 580);?>
			<?endif;?>
			<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
