...
<div class="history-list">
	<div class="history-item">
		<div class="history-item-title">
			Заказ №25 от 19.08.2016 09:58:22
		</div>
		<div class="history-item-content">
			<div class="history-col-2">
				<p>Сумма к оплате: <b>9 500 руб.</b></p>
				<p>Оплачен: Нет</p>
				<p>Способ оплаты: Самовывоз</p>
			</div>
			<div class="history-right-box">
				<div class="history-col-1">
					<p>10.08.2016 06:28:21</p>
					<p>Статус: выполняется</p>
				</div>
				<div class="history-col-1">
					<a href="#" class="btn-order-1">Оплатить</a>
				</div>
			</div>
			<div class="history-col-3">
				<p>Состав заказа:</p>
				<ul>
					<li><a href="#">Картридж TN-2275</a></li>
					<li><a href="#">Картридж TN-2175</a> - <span>2шт.</span></li>
					<li><a href="#">Заправка TN-2090</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="history-item">
		...
		<div class="history-item-content">
			...
			<div class="history-right-box">
				...
				<div class="history-col-1">
					<a href="#" class="btn-order-2">Повторить</a>
				</div>
			</div>
			<div class="history-col-3">
				<p>Состав заказа:</p>
